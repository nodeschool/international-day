...
私たち、**NodeSchool International Day**の主催者は、
...
性的な言語や画像を発信することは、**NodeSchool International Day**のミートアップや関連するイベントでは不適切です。
ハラスメント行為を止めるように言われた参加者は、すぐに従うことが期待されています。
スポンサーと発表者も、このアンチハラスメントの方針に従ってください。


参加者がハラスメント行為を行った場合、**NodeSchool International Day**の主催者は警告やイベントからの退場まで、
